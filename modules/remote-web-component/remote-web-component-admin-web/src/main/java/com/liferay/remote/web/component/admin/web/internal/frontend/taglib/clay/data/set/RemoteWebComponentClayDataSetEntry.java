 ...
 * @author Bruno Basto
 */
public class RemoteWebComponentClayDataSetEntry {

	public RemoteWebComponentClayDataSetEntry(
		RemoteWebComponentEntry remoteWebComponentEntry, Locale locale) {
	...
	public String getName() {
		return _remoteWebComponentEntry.getName(_locale);
	}

	public long getRemoteWebComponentEntryId() {
		return _remoteWebComponentEntry.getRemoteWebComponentEntryId();
	}

	public String getURL() {
		return _remoteWebComponentEntry.getUrl();
	}
